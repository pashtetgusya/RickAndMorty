...
// MARK: - Character info table view header view

/// Хедер таблицы информации о персонаже из вселенной `"Rick and Morty"`.
final class CharacterInfoTableViewHeaderView: UITableViewHeaderFooterView {
    ...
    private let tintLayer: CALayer = {
        ...
        layer.colors = [
            UIColor.viewDefaultBackgroundColor.withAlphaComponent(0).cgColor,
            UIColor.viewDefaultBackgroundColor.cgColor
        ]
    ...
    private var viewModel: CharacterInfoTableViewHeaderViewModel?
...
extension CharacterInfoTableViewHeaderView {
...
extension CharacterInfoTableViewHeaderView {
    ...
    /// Выполняет настройку ячейки на основе переданной вью модели с информацией о персонаже.
    /// - Parameter viewModel: вью модель ячейки.
    func setup(with viewModel: CharacterInfoTableViewHeaderViewModel) {
...
private extension CharacterInfoTableViewHeaderView {
