...
// MARK: Parameter collection view cell

/// Ячейка отображения параметра.
public final class ParameterCollectionViewCell: UICollectionViewListCell {
...
public extension ParameterCollectionViewCell {
...
public extension ParameterCollectionViewCell {
    ...
    func setup(with parameter: any Parameter) {
        accessories = parameter.withDisclosureIndicator ? [.disclosureIndicator()] : []
        selectedBackgroundView = parameter.withDisclosureIndicator ? nil : UIView()
...
private extension ParameterCollectionViewCell {
